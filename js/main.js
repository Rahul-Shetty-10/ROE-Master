...
//wishlist of product heart-fill
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.save').forEach(icon => {
        icon.addEventListener('click', () => {
            icon.classList.toggle('filled');
...
const swiper = new Swiper('.slider-wrapper', {
    ...
    // Navigation arrows
    navigation: {
        nextEl: '.merchandise-next',
        prevEl: '.merchandise-prev',
    },
...
const swipers = new Swiper('.online-event-slider-wrapper', {
...
const swiperss = new Swiper('.offline-event-slider-wrapper', {
